...
export default function BottomNav({ active = "today", onNavigate }) {
  ...
  return (
    <nav className="fixed bottom-[calc(10px+env(safe-area-inset-bottom))] left-1/2 z-40 grid h-[66px] w-[calc(100%-20px)] max-w-[390px] -translate-x-1/2 grid-cols-5 overflow-hidden rounded-[22px] border border-slate-100 bg-white/95 shadow-[0_12px_36px_rgba(15,23,42,0.14)] backdrop-blur-xl">
      {items.map((item) => {
